...
ALTER TABLE public.operationtypes
    ADD CONSTRAINT pk_operationtypes PRIMARY KEY (id);

ALTER TABLE public.reagentcategories
    ADD CONSTRAINT pk_reagentcategories PRIMARY KEY (id);

ALTER TABLE public.reagentoperations
    ADD CONSTRAINT pk_reagentoperations PRIMARY KEY (id);

ALTER TABLE public.reagentreceipts
    ADD CONSTRAINT pk_reagentreceipts PRIMARY KEY (id);
...
ALTER TABLE public.systemroles
    ADD CONSTRAINT pk_systemroles PRIMARY KEY (id);

ALTER TABLE public.users
    ADD CONSTRAINT pk_users PRIMARY KEY (id);

ALTER TABLE public.workschedule
    ADD CONSTRAINT pk_workschedule PRIMARY KEY (id);
...
ALTER TABLE public.notifications
    ...
    FOREIGN KEY (reagentid) REFERENCES public.reagents(id);
...
ALTER TABLE public.reagentoperations
    ADD CONSTRAINT fk_reagentoperations_reagent
    FOREIGN KEY (reagentid) REFERENCES public.reagents(id);

ALTER TABLE public.reagentoperations
    ADD CONSTRAINT fk_reagentoperations_user
    FOREIGN KEY (userid) REFERENCES public.users(id);

ALTER TABLE public.reagentoperations
    ADD CONSTRAINT fk_reagentoperations_operationtype
    FOREIGN KEY (operationtypeid) REFERENCES public.operationtypes(id);

ALTER TABLE public.reagentreceipts
    ADD CONSTRAINT fk_reagentreceipts_reagent
    FOREIGN KEY (reagentid) REFERENCES public.reagents(id);

ALTER TABLE public.reagentreceipts
    ADD CONSTRAINT fk_reagentreceipts_supplier
    FOREIGN KEY (supplierid) REFERENCES public.suppliers(id);

ALTER TABLE public.reagents
    ADD CONSTRAINT fk_reagents_category
    FOREIGN KEY (categoryid) REFERENCES public.reagentcategories(id);

ALTER TABLE public.users
    ADD CONSTRAINT fk_users_workschedule
    FOREIGN KEY (idworkschedule) REFERENCES public.workschedule(id);

ALTER TABLE public.users
    ADD CONSTRAINT fk_users_systemrole
    FOREIGN KEY (systemroleid) REFERENCES public.systemroles(id);

-- ------------------------------------------------------------
-- Useful indexes for FK/filter columns
-- ------------------------------------------------------------

CREATE INDEX ix_notifications_reagentid
    ON public.notifications (reagentid);

CREATE INDEX ix_notifications_userid
    ON public.notifications (userid);

CREATE INDEX ix_reagentoperations_reagentid
    ON public.reagentoperations (reagentid);

CREATE INDEX ix_reagentoperations_userid
    ON public.reagentoperations (userid);

CREATE INDEX ix_reagentoperations_operationtypeid
    ON public.reagentoperations (operationtypeid);

CREATE INDEX ix_reagentoperations_operationdate
    ON public.reagentoperations (operationdate);

CREATE INDEX ix_reagentreceipts_reagentid
    ON public.reagentreceipts (reagentid);

CREATE INDEX ix_reagentreceipts_supplierid
    ON public.reagentreceipts (supplierid);

CREATE INDEX ix_reagents_categoryid
    ON public.reagents (categoryid);

CREATE INDEX ix_reagents_expirationdate
    ON public.reagents (expirationdate);

CREATE INDEX ix_reagents_isactive
    ON public.reagents (isactive);
...
SELECT setval(
    pg_get_serial_sequence('public.notificationsettings', 'id'),
    COALESCE((SELECT MAX(id) FROM public.notificationsettings), 1),
    (SELECT COUNT(*) > 0 FROM public.notificationsettings)
);

SELECT setval(
    pg_get_serial_sequence('public.operationtypes', 'id'),
    COALESCE((SELECT MAX(id) FROM public.operationtypes), 1),
    (SELECT COUNT(*) > 0 FROM public.operationtypes)
);

SELECT setval(
    pg_get_serial_sequence('public.reagentcategories', 'id'),
    COALESCE((SELECT MAX(id) FROM public.reagentcategories), 1),
    (SELECT COUNT(*) > 0 FROM public.reagentcategories)
);

SELECT setval(
    pg_get_serial_sequence('public.reagentoperations', 'id'),
    COALESCE((SELECT MAX(id) FROM public.reagentoperations), 1),
    (SELECT COUNT(*) > 0 FROM public.reagentoperations)
);

SELECT setval(
    pg_get_serial_sequence('public.reagentreceipts', 'id'),
    COALESCE((SELECT MAX(id) FROM public.reagentreceipts), 1),
    (SELECT COUNT(*) > 0 FROM public.reagentreceipts)
);
...
SELECT setval(
    pg_get_serial_sequence('public.systemroles', 'id'),
    COALESCE((SELECT MAX(id) FROM public.systemroles), 1),
    (SELECT COUNT(*) > 0 FROM public.systemroles)
);
...
SELECT setval(
    pg_get_serial_sequence('public.workschedule', 'id'),
    COALESCE((SELECT MAX(id) FROM public.workschedule), 1),
    (SELECT COUNT(*) > 0 FROM public.workschedule)
);
